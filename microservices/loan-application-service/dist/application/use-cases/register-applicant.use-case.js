...
exports.RegisterApplicantUseCase = void 0;
...
let RegisterApplicantUseCase = class RegisterApplicantUseCase {
    ...
    async execute(command) {
        ...
        const applicant = new applicant_entity_1.Applicant(command.id, command.name, command.dni, command.incomeOrigin, command.monthlyIncome, command.mobile, command.email);
...
exports.RegisterApplicantUseCase = RegisterApplicantUseCase;
exports.RegisterApplicantUseCase = RegisterApplicantUseCase = __decorate([
